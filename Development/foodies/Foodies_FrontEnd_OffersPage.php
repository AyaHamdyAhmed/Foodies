...
if (isset($_SESSION['UserID'])) {
    ...
    $result2 = $user->showRestaurantswWithOffers($result);
} else {
    $user->logout();
}
?>
...
<head>
<title>Foodies - Restaurants with offers</title>
...
<div class="results">
	<div style="margin:100px; margin-top:10px; margin-right:250px;">
		...
		<a href="" id="href_prev" class="anchor previous">&laquo; Previous</a>
                <a href="Foodies_FrontEnd_OffersPage2.php" id="href_next" class="anchor next">Next &raquo;</a>
		</p>
	</div>
</div>
</div>
